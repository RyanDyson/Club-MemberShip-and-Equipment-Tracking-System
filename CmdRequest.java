public class CmdRequest extends RecordedCommand {
    ...
    @Override
    public void execute(String[] cmdParts) throws ExInsufficientArgument, ExNumberOfDaysLessThanOne, ExMemberNotFound, ExInvalidDateFormat, ExEquipmentNotFound, ExEquipmentSetAlreadyBorrowed, ExBorrowRequestPeriodOverlaps {
